...
<body>
<img src="<?php echo Yii::app()->theme->baseUrl.'/include/img/0102-01-01-01.jpg'?>" style="width: 100%;">
    ...
    <div id="wrapper">
        <div class="container-fluid mt-5 " style="  text-align: left;">
            <div class="containform mx-5">
                ...
                <p class="mt-4"><?php echo date('d-m-Y');?></p>
                <div class="row">
                    <div class="col-md-2">
                        <p>ขอเบิกค่า</p>
                    </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3">
                        ...
                        // include("datepicker.php");
                         ...
                         ?>
            <?php include Yii::app()->basePath .'/../themes/newdemo/include/datepicker.php';?>
                    </div>
                    <div class="col-md-4">
