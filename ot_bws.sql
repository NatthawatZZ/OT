...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 15, 2020 at 10:56 AM
...
CREATE TABLE `table_member` (
  ...
  `mb_password` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'รหัสผ่าน',
  ...
  `mb_mobile` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'หมายเลขโทรศัพท์มือถือ',
  `mb_email` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'อีเมล',
  `pst_id` int(2) NOT NULL COMMENT 'รหัสตำแหน่ง\n',
  `created_date` timestamp NULL DEFAULT current_timestamp() COMMENT 'วันที่สร้าง',
  `created_by` int(11) DEFAULT NULL COMMENT 'คนที่สร้าง',
  `update_date` datetime DEFAULT NULL COMMENT 'วันที่อัพเดท\n',
  `update_by` int(11) DEFAULT NULL COMMENT 'คนที่อัพเดท',
...
INSERT INTO `table_member` (`mb_id`, `psn_id`, `mb_password`, `mb_title`, `mb_name`, `mb_idcard`, `mb_mobile`, `mb_email`, `pst_id`, `created_date`, `created_by`, `update_date`, `update_by`, `active`) VALUES
(107, 1, 'fB2Y37T4dw', 'นาย', 'asdfas', 2147483647, '1234123412', 'oan_do9@hotmail.com', 28, '2020-01-14 07:47:39', NULL, NULL, NULL, 'y'),
(110, 2, 'X4vxWd6TZp', 'นางสาว', 'fasd', 2147483647, '0135444887', 'leodonut28@gmail.com', 34, '2020-01-14 08:13:03', NULL, NULL, NULL, 'y'),
(113, 1, '0123456789', 'นาย', 'มาร์ค น้อยย', 2147483647, '0897666444', 'mataratnatthawat@gmail.com', 37, '2020-01-15 09:37:56', NULL, NULL, NULL, 'y'),
(116, 1, '016554666', 'นางสาว', 'jjjg hh', 2147483647, '0899977755', 'test@mail.com', 38, '2020-01-15 09:47:45', NULL, NULL, NULL, 'y');
...
(1, '0001', '2020-01-01 00:00:00', NULL, '2020-01-01 00:00:00', NULL, 'y'),
(2, '0002', '2020-01-14 15:00:58', NULL, '2020-01-14 15:01:01', NULL, 'y');
...
--
ALTER TABLE `table_member`
  MODIFY `mb_id` int(4) NOT NULL AUTO_INCREMENT COMMENT 'รหัสสมาชิก', AUTO_INCREMENT=117;
